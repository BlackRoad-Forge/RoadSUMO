...
> Industrial-grade traffic simulation for fleet orchestration

Part of the [BlackRoad OS](https://blackroad.io) ecosystem. Forked from [`eclipse-sumo/sumo`](https://github.com/eclipse-sumo/sumo).
